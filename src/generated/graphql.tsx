...
export type PostsQuery = (
  ...
  & { posts: (
    { __typename?: 'PaginatedPostsResponse' }
    & Pick<PaginatedPostsResponse, 'hasMore'>
    & { posts: Array<(
      { __typename?: 'Post' }
      & PostSnippetFragment
    )> }
...
export const RegisterDocument = gql`
    mutation Register($options: RegisterOptions!) {
...
export const UpdatePostDocument = gql`
    mutation UpdatePost($id: Int!, $title: String!, $text: String!, $snippetLimit: Int!) {
 ...
 *      text: // value for 'text'
 *      snippetLimit: // value for 'snippetLimit'
 *   },
 * });
 */
